      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            What I Bring <br className="hidden sm:block" />to Your Project
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            A comprehensive skill set built through years of experience in modern web development.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Modern React, Vue.js, and vanilla JavaScript with responsive design and optimal user experiences."
            index={0}
          />
          <FeatureCard
            ...
            description="Scalable APIs with Node.js, Python, and database design for robust server-side solutions."
            index={1}
          />
          <FeatureCard
            ...
            description="Efficient database architecture with MongoDB, PostgreSQL, and optimization for performance."
            index={2}
          />
          <FeatureCard
            ...
            title="Cloud & DevOps"
            description="AWS deployment, containerization with Docker, and CI/CD pipelines for seamless delivery."
            index={3}
          />
          <FeatureCard
            ...
            title="UI/UX Design"
            description="User-centered design principles with prototyping and testing for intuitive interfaces."
            index={4}
          />
          <FeatureCard
            ...
            description="Agile methodologies, clear communication, and timely delivery of high-quality solutions."
            index={5}
          />
        </div>
      </div>
